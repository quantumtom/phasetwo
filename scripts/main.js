...
(function() {
	...
	function bindEvents() {
		...
		// elms.grid.addEventListener("hover", function(e) {
		...
		elms.artContent.addEventListener(transitionEvent, function(e) {
			if (this.classList.contains("slide-content-left") && e.propertyName == 'transform') {
		...
		elms.overlay.addEventListener(transitionEvent, function(e) {
			...
			// if (e.propertyName == 'opacity' && !this.classList.contains('info-overlay-open')) {
